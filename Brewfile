...
tap "suzuki-shunsuke/tfprovidercheck"
...
brew "tfenv" # Terraform version manager. TFENV_ARCH=amd64 tfenv install 1.3.3 
brew "terraform-docs"

brew "bazelisk" # A user-friendly launcher for Bazel.
brew "sdkman-cli"
