...
```bash
git clone git@github.com:rochana-atapattu/dotfiles.git
```
...
open a new [discussion](https://github.com/rochana-atapattu/dotfiles/discussions/new)
